...
return [
    ...
    'admin.pages.new' => 'Nova página',
    'admin.pages.edit' => 'Editar página',
    'admin.pages.delete' => 'Excluir',
    'admin.pages.id' => 'ID',
    'admin.pages.slug' => 'Slug',
    'admin.pages.status' => 'Status',
    'admin.pages.updated' => 'Atualizado',
    'admin.pages.actions' => 'Ações',
    ...
    'admin.pages.saved' => 'Salvo',
    'admin.pages.error_invalid' => 'Erro. Verifique os campos.',
    'admin.pages.error_slug_exists' => 'O slug já existe.',
    'admin.pages.error_reserved_slug' => 'Este slug é reservado.',
    'admin.pages.form.preview' => 'Pré-visualizar',
