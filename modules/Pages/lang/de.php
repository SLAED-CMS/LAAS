...
return [
    'admin.pages.title' => 'Seiten',
    'admin.pages.new' => 'Neue Seite',
    'admin.pages.edit' => 'Bearbeiten',
    'admin.pages.delete' => 'Löschen',
    'admin.pages.id' => 'ID',
    'admin.pages.slug' => 'Slug',
    'admin.pages.status' => 'Status',
    'admin.pages.updated' => 'Aktualisiert',
    'admin.pages.actions' => 'Aktionen',
    'admin.pages.form.title' => 'Titel',
    ...
    'admin.pages.saved' => 'Gespeichert',
    'admin.pages.error_invalid' => 'Fehler. Bitte die Felder prüfen.',
    'admin.pages.error_slug_exists' => 'Der Slug existiert bereits.',
    'admin.pages.error_reserved_slug' => 'Dieser Slug ist reserviert.',
    'admin.pages.form.preview' => 'Vorschau',
