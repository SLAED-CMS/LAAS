...
return [
    'admin.pages.title' => 'Halaman',
    'admin.pages.new' => 'Halaman baru',
    'admin.pages.edit' => 'Edit halaman',
    'admin.pages.delete' => 'Hapus',
    'admin.pages.id' => 'ID',
    'admin.pages.slug' => 'Slug',
    'admin.pages.status' => 'Status',
    'admin.pages.updated' => 'Diperbarui',
    'admin.pages.actions' => 'Aksi',
    'admin.pages.form.title' => 'Judul',
