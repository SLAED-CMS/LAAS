...
{
    private const MAP = [
        ErrorCode::AUTH_REQUIRED => ['status' => 401, 'message_key' => 'auth.unauthorized'],
        ErrorCode::AUTH_INVALID => ['status' => 401, 'message_key' => 'auth.unauthorized'],
        ErrorCode::RBAC_DENIED => ['status' => 403, 'message_key' => 'rbac.forbidden'],
        ErrorCode::CSRF_INVALID => ['status' => 403, 'message_key' => 'security.csrf_failed'],
        ErrorCode::RATE_LIMITED => ['status' => 429, 'message_key' => 'http.rate_limited'],
        ErrorCode::VALIDATION_FAILED => ['status' => 422, 'message_key' => 'error.validation_failed'],
        ErrorCode::NOT_FOUND => ['status' => 404, 'message_key' => 'http.not_found'],
        ...
        ErrorCode::INVALID_REQUEST => ['status' => 400, 'message_key' => 'http.bad_request'],
    ...
    private const ALIASES = [
        ...
        'auth.unauthorized' => ['code' => ErrorCode::AUTH_REQUIRED, 'message_key' => 'auth.unauthorized', 'status' => 401],
        ...
        'rbac.forbidden' => ['code' => ErrorCode::RBAC_DENIED, 'message_key' => 'rbac.forbidden', 'status' => 403],
        'not_found' => ErrorCode::NOT_FOUND,
        'http.not_found' => ['code' => ErrorCode::NOT_FOUND, 'message_key' => 'http.not_found', 'status' => 404],
        ...
        'http.rate_limited' => ['code' => ErrorCode::RATE_LIMITED, 'message_key' => 'http.rate_limited', 'status' => 429],
        ...
        'http.bad_request' => ['code' => ErrorCode::INVALID_REQUEST, 'message_key' => 'http.bad_request', 'status' => 400],
        ...
        'error.auth_required' => ['code' => ErrorCode::AUTH_REQUIRED, 'message_key' => 'auth.unauthorized', 'status' => 401],
        'error.auth_invalid' => ['code' => ErrorCode::AUTH_INVALID, 'message_key' => 'auth.unauthorized', 'status' => 401],
        'error.rbac_denied' => ['code' => ErrorCode::RBAC_DENIED, 'message_key' => 'rbac.forbidden', 'status' => 403],
        'error.not_found' => ['code' => ErrorCode::NOT_FOUND, 'message_key' => 'http.not_found', 'status' => 404],
        'error.invalid_request' => ['code' => ErrorCode::INVALID_REQUEST, 'message_key' => 'http.bad_request', 'status' => 400],
        'error.service_unavailable' => ['code' => ErrorCode::SERVICE_UNAVAILABLE, 'message_key' => 'service_unavailable', 'status' => 503],
        'rate_limit.exceeded' => ['code' => ErrorCode::RATE_LIMITED, 'message_key' => 'http.rate_limited', 'status' => 429],
