...
return new class {
    public function up(PDO $pdo): void
    {
        ...
        $permId = $this->ensurePermission($pdo, 'rbac.manage', 'RBAC manage');
    ...
    public function down(PDO $pdo): void
    {
        ...
        $pdo->prepare('DELETE FROM permissions WHERE name = :name')->execute(['name' => 'rbac.manage']);
    }
