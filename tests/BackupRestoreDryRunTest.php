...
final class BackupRestoreDryRunTest extends TestCase
{
    public function testDryRunDoesNotTouchDbOrMedia(): void
    {
        ...
        $restore = $manager->restore((string) $result['file'], [
            'dry_run' => true,
            'force' => true,
        ]);
    ...
    {
        $root = sys_get_temp_dir() . '/laas_backup_restore_' . bin2hex(random_bytes(4));
