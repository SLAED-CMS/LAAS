...
final class AdminPagesBlocksJsonSaveTest extends TestCase
{
    ...
    public function testSavePersistsBlocksRevision(): void
    {
        ...
        $this->assertSame(1, (int) $pdo->query('SELECT COUNT(*) FROM pages')->fetchColumn());
        $this->assertSame(1, (int) $pdo->query('SELECT COUNT(*) FROM pages_revisions')->fetchColumn());

        $stored = (string) $pdo->query('SELECT blocks_json FROM pages_revisions WHERE page_id = 1')->fetchColumn();
