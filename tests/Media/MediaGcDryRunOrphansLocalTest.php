...
final class MediaGcDryRunOrphansLocalTest extends TestCase
{
    public function testDryRunKeepsOrphans(): void
    {
        ...
        try {
            ...
            $this->assertSame(1, $result['orphans_found']);
            $this->assertSame(0, $result['deleted_count']);
            $this->assertFileExists($root . '/storage/' . $orphanDisk);
