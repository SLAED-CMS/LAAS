(function () {
  ...
  function laasInitSlugForm(root) {
    ...
    var initialTitle = titleInput.value.trim();
    var autoGenerated = initialSlug === '' || initialSlug === laasSlugify(initialTitle);
    slugInput.dataset.autoGenerated = autoGenerated ? '1' : '0';
    ...
    titleInput.addEventListener('input', function () {
      if (slugInput.dataset.autoGenerated !== '1') {
        return;
      }
